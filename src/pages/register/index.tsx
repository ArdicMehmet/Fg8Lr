  ...
  return (
    <div className="loginContainer flex mx-auto">
        ...
        <div className="flex flex-1 flex-col justify-between">
          ...
          <div className="buttons h-1/5 flex justify-center">
            <div className="w-1/2 flex flex-col items-center">
              <button className="common-pointer cursor-pointer font-bold h-[60px] leading-[normal] text-2xl md:text-[22px] text-center sm:text-xl w-[330px] registerBtn rounded w-full text-[color:white]">Register</button>
              <button className='common-pointer cursor-pointer font-bold h-[60px] leading-[normal] mt-2.5 text-2xl md:text-[22px] text-center sm:text-xl w-[330px] rounded border border-deep_purple-400 border-solid text-deep_purple-400'>Login</button>
            </div>
