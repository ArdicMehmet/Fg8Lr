...
export const LoginPage:React.FC = () => {
  return (
    <div className="loginContainer flex mx-auto">
        <div className="leftPage flex-1 bg-[url('./images/home-bg.png')] h-screen mask1 bg-cover"></div>
        <div className="flex flex-1 flex-col justify-between">
          ...
          <div className="main w-full h-3/5 flex justify-center items-center">
            <div className="formContainer flex flex-col justify-center">
              ...
              <form className='mt-6'>
                <div className="grid gap-2 mb-0 md:grid-cols-1">
                  <div>
                    <div className="mb-6">
          ...
          <div className="w-full h-1/5 flex flex-col items-center">
              <Button name='Login' className='common-pointer cursor-pointer font-bold h-[60px] leading-[normal] text-2xl md:text-[22px] text-center sm:text-xl w-[330px] rounded border border-deep_orange-400 border-solid text-white-A700 bg-deep_orange-400' />      
              <Button name='Register' className='common-pointer cursor-pointer font-bold h-[60px] leading-[normal] mt-2.5 text-2xl md:text-[22px] text-center sm:text-xl w-[330px] rounded border border-deep_purple-400 border-solid text-deep_purple-400'/>      
          </div>
        </div>
      </div> 
  )
