...
function Header() {
  return (
    <header className='w-full h-[120px] flex justify-between ps-[60px] pe-[60px]'>
        <div className="brand flex justify-center items-center w-1/6">
            <img className='w-[60px] h-[39px]' src={logo} alt="logo" />
        </div>
        <div className='flex justify-center items-center w-4/6'>
            <div className='findContainer w-[800px] relative text-[20px]'>
                <input type="text" className='w-full h-[50px] outline-0 ps-[40px] rounded bg-gray-50' placeholder='Search'/>
            </div>
            
        </div>
        <div className='profileMenu flex justify-center items-center w-1/6'>
